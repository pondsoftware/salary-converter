...
const US_METROS = [
  ...
  { name: "Portland, OR", slug: "portland", index: 130.4 },
  { name: "Charlotte, NC", slug: "charlotte", index: 100.8 },
  { name: "Jacksonville, FL", slug: "jacksonville", index: 97.2 },
  { name: "Fort Worth, TX", slug: "fort-worth", index: 98.5 },
  { name: "Milwaukee, WI", slug: "milwaukee", index: 95.4 },
  { name: "Baltimore, MD", slug: "baltimore", index: 112.6 },
  { name: "Louisville, KY", slug: "louisville", index: 91.2 },
  { name: "Las Vegas, NV", slug: "las-vegas", index: 103.5 },
  { name: "Tucson, AZ", slug: "tucson", index: 93.8 },
  { name: "Fresno, CA", slug: "fresno", index: 102.7 },
  { name: "Sacramento, CA", slug: "sacramento", index: 121.3 },
  { name: "Mesa, AZ", slug: "mesa", index: 101.9 },
  { name: "Omaha, NE", slug: "omaha", index: 90.4 },
  { name: "Cleveland, OH", slug: "cleveland", index: 92.1 },
  { name: "Tampa, FL", slug: "tampa", index: 102.3 },
  { name: "New Orleans, LA", slug: "new-orleans", index: 98.7 },
  { name: "Cincinnati, OH", slug: "cincinnati", index: 92.8 },
  { name: "St. Louis, MO", slug: "st-louis", index: 89.5 },
  { name: "Orlando, FL", slug: "orlando", index: 103.1 },
];
